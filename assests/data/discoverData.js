const discoverData = [
  {
    ...
    description:
      'An ideal introduction to sea kayaking ' +
      "around the stunning historical Islands of Tofino's harbour." +
      'Come explore the spectacular scenery of the area and learn what makes the area.',
    liked: true,
    price: 50,
    rating: 5,
    duration: 2,
  },
  {
    ...
    imageBig: require('../images/canyonBig.png'),
    description:
